'''
this is a more robust version of the trading logic class where I compare volume of the stock from historical data
more closely and compare it to the average as part of how the bot buys or sells a stock, along with logging print statements
and errors for future debugging.
import pandas as pd
import time
import logging
