...
class TradingLogic:
    ...
    def start_trading(self):
        while True:
            if self.dataHandler.is_market_open():
    ...
    def trading_logic(self, api, symbol, qty):
        positions = self.api.list_positions()
        ownedStocks = {positions.smbol: float(positions.qty) for position in positions}
        ...
        # Ensure RSI is calculated properly
